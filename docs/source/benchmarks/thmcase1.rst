...
An arbitrary problem to compare the :class:`cedar.Flow` model in Cedar to the
MOOSE THM. This is internal flow through a cylindrical flow channel with uniform
heat addition and wall friction effects.

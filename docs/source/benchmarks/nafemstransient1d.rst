...
This is a transient problem that comes from The Standard NAFEMS Benchmarks
[NAFEMS_1990]_. It tests the :class:`cedar.HeatTransfer` model's ability to
handle time-dependent boundary conditions, time derivatives, and spatial
derivatives.

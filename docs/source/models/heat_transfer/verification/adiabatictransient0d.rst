...
An arbitrary problem to test the time derivatives of the
:class:`cedar.HeatTransfer` model. Since it has adiabatic boundaries with a
uniform volumetric heat generation, the problem effectively reduces down to a
time-dependent point value. The geometry and domain discretization should have
